...
namespace lucid
{
    ...
    public class AllDetailsActivity : Activity
    {
        ...
        private AllDetailsRecyclerViewAdapter mRecyclerViewAdapter;
        ...
        private void SetUpVariables()
        {
            ...
            Task.Run(() =>
            {
                ad_timer = new Timer(INTERVAL);
                COUNTDOWN = INITIAL;
                ad_timer.Elapsed += Timer_Elapsed;
                ad_timer.Start();
            });
        }
        ...
        // error message because data cant be retrieved
        ...
        //alert dialog due to inactivity
